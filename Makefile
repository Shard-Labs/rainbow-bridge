...
deploy-nft-full-contracts:
	cli/index.js init-near-contracts
	cli/index.js init-eth-ed25519
	cli/index.js init-eth-client
	cli/index.js init-eth-prover
	cli/index.js init-eth-nft-factory
	cli/index.js init-near-nft-locker
	cli/index.js init-near-nft

mint-nft:
	cli/index.js TESTING near-mock-nft --token-id 2 --action add

get-nft:
	cli/index.js TESTING near-mock-nft --token-id 2 --action get

approve-nft:
	cli/index.js TESTING near-mock-nft --token-id 2 \
		--near-recipient-account nearlocker.node0 --action approve

transfer-near-to-evm:
	cli/index.js TESTING transfer-near-nft-to-evm --token-id 2 \
		--near-sender-account node0 \
		--eth-receiver-address 0x1C925b70D9dC5Cde0b868c939043f61525967380 \
